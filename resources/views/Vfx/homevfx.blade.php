        ...
        <div class="container margin-bottom-medium">
            ...
            <div class="filters">
                <ul class="wow lightSpeedIn">
                    ...
                    <li><a href="/all_theed">3D Animation</a></li>
                    <li><a href="/all_vfx" class="active">VFX</a></li>
...
@foreach($vfxs as $vfx)
    <div class="portfolio-item twod col-md-4 product-box" style="position: absolute; left: 0px; top: 0px; width: 379px;border-style: solid; border-color: white;">
        <div class="portfolio">
            <a href="#" data-lightbox-gallery="portfolio">
                <img src="{{asset('/titleImage/'.$vfx->titleImage)}}" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                <div class="portfolio-overlay hvr-rectangle-out">
                    ...
                    <div type="button" class="button modelData" rel="{{$vfx->id}}" data-toggle="modal" data-target=".bs-example-modal-center">View Project</div>
    ...
    {{ $vfxs->links('vendor.pagination.bootstrap-4') }}
