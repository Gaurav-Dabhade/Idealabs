        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-1 col-sm-6 col-sm-offset-1 col-xs-12 wow slideInLeft animated">
                    <p class="light-text">Like What You See? We&lsquo;re Just Getting Started</p>
                </div>
...
@foreach($videos as $video)
    <div class="portfolio-item twod col-md-4 product-box" style="position: absolute; left: 0px; top: 0px; width: 379px;border-style: solid; border-color: white;">
        <div class="portfolio">
        <a data-lightbox-gallery="portfolio">
                <img src="{{asset('/titleImage/'.$video->titleImage)}}" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                <div class="portfolio-overlay hvr-rectangle-out">
                    ...
                    <div type="button" class="button modelData" rel="{{$video->id}}" data-toggle="modal" data-target=".bs-example-modal-center">View Project</div>
                    {{-- <button class="button modelData"  data-toggle="modal" data-target="#model-view"></button> --}}
