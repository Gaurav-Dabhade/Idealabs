        ...
        <div class="container margin-bottom-medium">
            ...
            <div class="filters">
                <ul class="wow lightSpeedIn">
                    ...
                    <li><a href="/all_walk" class="active">Architecture Walkthrough</a></li>
...
@foreach($walks as $walk)
    <div class="portfolio-item twod col-md-4 product-box" style="position: absolute; left: 0px; top: 0px; width: 379px;border-style: solid; border-color: white;">
        <div class="portfolio">
            <a href="#" data-lightbox-gallery="portfolio">
                <img src="{{asset('/titleImage/'.$walk->titleImage)}}" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                <div class="portfolio-overlay hvr-rectangle-out">
                    ...
                    <div type="button" class="button modelData" rel="{{$walk->id}}" data-toggle="modal" data-target=".bs-example-modal-center">View Project</div>
    ...
    {{ $walks->links('vendor.pagination.bootstrap-4') }}
