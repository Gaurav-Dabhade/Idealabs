                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="post" enctype="multipart/form-data" action="/dashboard/store_brand">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="tag" class="form-control select2">
                                                            ...
                                                            <option value="Business Branding" selected>Business Branding</option>
