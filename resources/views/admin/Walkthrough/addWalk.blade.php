                            ...
                            <div class="page-title-box">
                                <h4>Dashboard</h4>
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Add Architecture Walkthrough</li>
                                    </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="post" enctype="multipart/form-data" action="/dashboard/store_walk">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="tag" class="form-control select2">
                                                            ...
                                                            <option value="Architecture Walkthrough" selected>Architecture Walkthrough</option>
