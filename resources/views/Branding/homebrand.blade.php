        ...
        <div class="container margin-bottom-medium">
            ...
            <div class="filters">
                <ul class="wow lightSpeedIn">
                    ...
                    <li><a href="/all_brand" class="active">Bussiness Branding</a></li>
    ...
    <div class="portfolio-item twod col-md-4 product-box" style="position: absolute; left: 0px; top: 0px; width: 379px;border-style: solid; border-color: white;">
        <div class="portfolio">
            <a href="#" data-lightbox-gallery="portfolio">
                <img src="{{asset('/titleImage/'.$brand->titleImage)}}" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                <div class="portfolio-overlay hvr-rectangle-out">
                    ...
                    <div type="button" class="button modelData" rel="{{$brand->id}}" data-toggle="modal" data-target=".bs-example-modal-center">View Project</div>
